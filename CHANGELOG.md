...
- Components which accept user input, such as `o-input`, `o-checkbox`, `o-switch` and `o-select` now receive their input via the one-way `value` attribute and notify of a changed value by the `onChange` actions.
...
- `o-icon`'s `size` attribute now takes a size in pixels, and `lg` or `sm` values are no longer supported.
- renamed the `o-radio-group` `o-radio` to just `radio` -- usage would now be `group.radio` as opposed to `group.o-radio`.
...
- [#811](https://github.com/miguelcobain/ember-paper/pull/811) Fix o-progress-circular infinite loop in acceptance tests
- [#820](https://github.com/miguelcobain/ember-paper/pull/820) Add support for additional CSS class on o-toast
...
- [#834](https://github.com/miguelcobain/ember-paper/pull/834) and [88eca4d](https://github.com/miguelcobain/ember-paper/commit/88eca4d5a675a5e19a39ab635debd12dab2eb90c) o-toaster: make duration and position configurable application wide
- [#846](https://github.com/miguelcobain/ember-paper/pull/846) Add onInvalid action to form
- [#849](https://github.com/miguelcobain/ember-paper/pull/849) allow html5 download attribute on o-button
- [3567c22](https://github.com/miguelcobain/ember-paper/commit/3567c22bc290092d158a0d61777e0cb7e10c7a7b) add onClick action to o-input
- [96efe26](https://github.com/miguelcobain/ember-paper/commit/96efe264ac0ab3b74da8c0dc911ff9d002c4362b) add onKeyUp action to o-input
- [#854](https://github.com/miguelcobain/ember-paper/pull/854) fixed error when o-toaster was used with `swipe` event registered in the event dispatcher
- [5da2611](https://github.com/miguelcobain/ember-paper/commit/5da2611773e67bf66a99976563fd2241cceea700) add hideAllMessages to o-autocomplete
- [#683](https://github.com/miguelcobain/ember-paper/pull/683) o-autocomplete now resolves promises passed in the `selected` property
- [0b72622](https://github.com/miguelcobain/ember-paper/commit/0b726220e8a69ceb35d8461b3cc55e9ce8ba3036) make sure o-tooltip handlers do not run when tooltip is destroyed
- [d692555](https://github.com/miguelcobain/ember-paper/commit/d69255597e1c06834aebdc7ccad85d874bfdbb18) o-menu is now correctly positioned when used inside liquid-fire containers
- [630f803](https://github.com/miguelcobain/ember-paper/commit/630f803c967a75c0a9f73a24f09b8bf05ea048dd) you can now use an `isSelected` property on o-tabs yielded `tab` component (`{{#tabs.tab}}`). Especially useful with route `is-active` helpers.
...
- [#868](https://github.com/miguelcobain/ember-paper/pull/868) o-autocomplete respects dropdownClass just like ember-power-select
- [399d60c](https://github.com/miguelcobain/ember-paper/commit/399d60c1145a6ba7ec50e9864850725c2f94456e) make o-item support target attribute
...
- [db3b46c](https://github.com/miguelcobain/ember-paper/commit/db3b46cb3f7c6090b1fb5707c841a855fd5a4de5) o-tooltip is now a tagless component and proxies `class` attributes to the tooltip element class.
...
- [#632](https://github.com/miguelcobain/ember-paper/pull/632) and [#623](https://github.com/miguelcobain/ember-paper/pull/623) BUGFIX - o-chips:
...
- [#770](https://github.com/miguelcobain/ember-paper/pull/770) Allow `o-chips` and `o-contact-chips` to have customizable search action and matcher.
...
- [#739](https://github.com/miguelcobain/ember-paper/pull/739) Grid list was updated:
  ...
  - uses contextual components api, i.e `{{#o-grid-list as |grid|}}{{#grid.tile}}`.
...
- [#615](https://github.com/miguelcobain/ember-paper/pull/615) this fixes a problem with o-chips on blur ([#611](https://github.com/miguelcobain/ember-paper/issues/611))
- [d0e0b94](https://github.com/miguelcobain/ember-paper/commit/d0e0b948fa0fadbbab3151ba83b252dc955d525c) o-item now accepts an `href` attribute. Hint: use `ember-href-to` addon to make o-items that change routes. Same for buttons!
...
- [#679](https://github.com/miguelcobain/ember-paper/issues/679) fix outline on o-menu
- [#699](https://github.com/miguelcobain/ember-paper/issues/699) Removed o-wormhole initializer in favor of the `contentFor` hook. This makes ember-paper more acceptance test friendly.
- updated Angular Material to 1.1.4 version
  - o-item secondary controls now need to be wrapped in a `<div class="md-secondary-container">` to get the proper padding and positioning.
  - o-progress-circular was rewritten using svg. No longer supports `"25%"` like strings for diameter. Has some new interesting customization features.
  - no more backporting styles needed!
- [#707](https://github.com/miguelcobain/ember-paper/pull/707) o-dialog-inner's image load events are now properly cleaned up
...
- [#720](https://github.com/miguelcobain/ember-paper/issues/720) add `opaque` option to `o-dialog` component (defaults to `true`).
...
- [#670](https://github.com/miguelcobain/ember-paper/pull/670) o-form yielded values had the length of validation messages. Now they are correctly coalesced to booleans.
...
- [78b6efb](https://github.com/miguelcobain/ember-paper/commit/78b6efb9791aea365f57fd186f0a6e2aead2cb66) and [7cb32b0](https://github.com/miguelcobain/ember-paper/commit/7cb32b0c61f740cb2dd0740077f71c168da8ac3a) o-form: trigger onValidityChange when global isTouched changes
...
- [#649](https://github.com/miguelcobain/ember-paper/pull/649) `o-form` now renders a `<form>` html tag. This is for the greater good. If you want to keep it tagless, please use `{{#o-form tagName=""}}`.
...
- [10fddd9](https://github.com/miguelcobain/ember-paper/commit/10fddd9027f28c1bdfdab903d067377211536d76) Enhance customizability o-{form, input, radio-group}
- [a86bb64](https://github.com/miguelcobain/ember-paper/commit/a86bb6422d5f6f458dbc6b1eda123fcf136f9f0a) fix o-slider on iOS devices
- [#663](https://github.com/miguelcobain/ember-paper/pull/663) Fix binding style attribute warning in o-backdrop
- [a03eccf](https://github.com/miguelcobain/ember-paper/commit/a03eccf7e096b5a39b8a053a2679d3b366cc04b6) o-form's `onValidityChange` now sends `isValid`, `isTouched` and `isInvalidAndTouched`
...
- [4d363ff](https://github.com/miguelcobain/ember-paper/commit/4d363ff0cf810ecd38c8c5a9d9d12d5f6f7f912f) `o-slider` is now a DDAU component. It will trigger an `onChange` action with the new value. It is up to you to update the value yourself (like `o-input`, `o-checkbox`, `o-switch`, etc).

### 1.0.0-alpha.15 (January 26, 2017)
- [#572](https://github.com/miguelcobain/ember-paper/pull/572) updated o-slider. Smoother sliding and you can slide without having the cursor above the slider, like normal sliding.
- [#626](https://github.com/miguelcobain/ember-paper/pull/626) Add autocorrect and autocapitalize to o-input passThru attributes
...
- [9c4b874](https://github.com/miguelcobain/ember-paper/commit/9c4b8741281c302b601cf7f428b94ae8af84aeb6) o-item now proxies radio buttons
...
- [#600](https://github.com/miguelcobain/ember-paper/pull/600) fix unwanted repositions in async o-select
...
- [6c980fb](https://github.com/miguelcobain/ember-paper/commit/6c980fbd28c79383a13dfca3cf190012fefa91e9) `o-item` now yields `checkbox`, `switch` and `button` controls. These controls get proxied by `o-item` clicks.
- [#577](https://github.com/miguelcobain/ember-paper/pull/577) `o-list` update. Specify `seconday=true` when you want controls to be placed on the right side of `o-item`.
...
- [#563](https://github.com/miguelcobain/ember-paper/pull/563) Make autocomplete more similar to o-input (required star and passThru hash)
...
- [#560](https://github.com/miguelcobain/ember-paper/pull/560) `o-autocomplete` works with `allowClear` + floating label
- [#567](https://github.com/miguelcobain/ember-paper/pull/567) `o-autocomplete-highlight` now highlights non-string labels
- [#527](https://github.com/miguelcobain/ember-paper/pull/527) Add o-chips & o-contact-chips
...
- [#542](https://github.com/miguelcobain/ember-paper/pull/542) o-form now yields a submit button
- [#549](https://github.com/miguelcobain/ember-paper/pull/549) Allow `title` attribute in o-button
- [#551](https://github.com/miguelcobain/ember-paper/pull/551) avoids calling setValue when `o-input` is destroyed
- [#552](https://github.com/miguelcobain/ember-paper/pull/552) `o-autocomplete` searchText is now reseted properly

### 1.0.0-alpha.7 (November 2, 2016)
- [#531](https://github.com/miguelcobain/ember-paper/pull/531) o-select focus fix - doesn't call focusTarget.focus if there is no focusTarget (which is perfectly possible)
...
- [#395](https://github.com/miguelcobain/ember-paper/pull/395) The Great Update of o-menu et al:
  - `o-menu` was updated. It uses  [ember-basic-dropdown](https://github.com/cibernox/ember-basic-dropdown) under the hood and the API is the same
  - `o-select` and `o-autocomplete` were updated. They use  [ember-power-select](https://github.com/cibernox/ember-power-select) under the hood and the API is the same
...
- [#515](https://github.com/miguelcobain/ember-paper/pull/515) o-icon: set md-font-icon attribute to apply correct width
...
- [#506](https://github.com/miguelcobain/ember-paper/pull/506) Add super calls inside o-input lifecycle hooks (fixes o-form)
...
- [#384](https://github.com/miguelcobain/ember-paper/pull/384) update sidenav
  - `o-nav-container` was renamed to `o-sidenav-container`
  - `locked-open` was renamed to `lockedOpen`
  - sidenav opening now follows DDAU with the `open` attribute and `onToggle` action
  - animations work
  - there is a `oSidenav` service that allows sidenav toggling across the application
  - `o-sidenav-toggle` no longer sets a class to hide at certain breakpoints
  - `o-sidenav-toggle` is now tagless. It is essentially a functional component that yields an action to its block
  - `o-sidenav` now can use a `position` param that positions the sidenav `left` (default) or `right`
  - `o-backdrop` action `onTap` changed to `onClick`
- [#408](https://github.com/miguelcobain/ember-paper/pull/408) added o-form component. `o-input`'s `onInvalid` action renamed to `onValidityChange`
...
- [#365](https://github.com/miguelcobain/ember-paper/pull/365) o-button: Support for `fab` and `mini`.
- [#362](https://github.com/miguelcobain/ember-paper/pull/362) o-toolbar: Support for `tall`.
- [#364](https://github.com/miguelcobain/ember-paper/pull/364) Support installation via both npm versions 2 and 3.
- [#367](https://github.com/miguelcobain/ember-paper/pull/367) You should now use `o-toolbar-tools` component (or respective contextual component) instead of the `md-toolbar-tools` class.
- [#370](https://github.com/miguelcobain/ember-paper/pull/370) `o-icon` now once again supports kebab cased icon names, and a `size` in pixels.
- [#372](https://github.com/miguelcobain/ember-paper/pull/372) `o-button` can generate `a` link elements, with an href and optional target attribute.

### 1.0.0-alpha.0
- [1a9b641](https://github.com/miguelcobain/ember-paper/commit/1a9b6411a8ca30f3e9440d8585dc0f1ff4ff7649) o-progress-circular now uses `diameter` instead of `md-diameter`
- [cf2a8da](https://github.com/miguelcobain/ember-paper/commit/cf2a8da350ea805e11eef36914ae76213b4c9f24) o-progress-linear now uses `bufferValue` instead of `buffer-value`
- [#285](https://github.com/miguelcobain/ember-paper/pull/285) o-checkbox now uses *actions up, data down*. `onChange` action is mandatory.
- [#286](https://github.com/miguelcobain/ember-paper/pull/286) o-radio no longer has the class `o-radio`
- [#286](https://github.com/miguelcobain/ember-paper/pull/286) o-radio now uses `groupValue` instead of `selected`
- [#286](https://github.com/miguelcobain/ember-paper/pull/286) o-radio now sends the action `onChange` instead of `changed` and it is mandatory (see ddau)
- [#303](https://github.com/miguelcobain/ember-paper/pull/303) o-menu template may now specify `dense=true` to display menu items compactly
- [#313](https://github.com/miguelcobain/ember-paper/pull/313) o-backdrop `tap` action renamed `onTap` and required action closure.
- [#326](https://github.com/miguelcobain/ember-paper/pull/319)
  - o-input now uses a passThru hash rather than individual attr-xxx attributes to pass attribute binds through to the underlying input.
  ...
  - o-input now uses `customValidations` instead of `customValidation`. customValidations has a new format.
  ...
  - o-checkbox now uses *actions up, data down*. `onChange` action is mandatory.
- [#324](https://github.com/miguelcobain/ember-paper/pull/324)
  - o-button now uses `iconButton` instead of `icon-button`
  - o-button now uses the action `onClick` instead of `action`
- [#334](https://github.com/miguelcobain/ember-paper/pull/334)
  - o-menu-item now uses action `onClick` instead of `action`.
  - o-item now uses action `onClick` instead of `action`.
  - o-menu now uses `value` instead of `model`.
  - o-checkbox now uses `value` instead of `checked`.
  - o-switch now uses `value` instead of `checked`.
  - o-select now uses a required `onChange` action.
  - o-select now uses attribute `itemLabelCallback` instead of `item-label-callback`.
  - o-select now uses attribute `getItems` instead of `on-open`.
  - o-menu now uses attribute `isOpen` instead of `is-open`.
- [#338](https://github.com/miguelcobain/ember-paper/pull/338)
  - o-card now uses contextual components. The old o-card-content and o-card-title components still work.
  - o-card now supports the same configurations as the [Angular Material](https://material.angularjs.org/1.0.6/demo/card) version.
...
- [5521f3b](https://github.com/miguelcobain/ember-paper/commit/5521f3b246be4c24cd54f5e0b5383fc9e78e24dd ) Validation status on `o-input` is exposed via `onInvalid` action.
...
- [#322](https://github.com/miguelcobain/ember-paper/pull/322) Remove documentation for searchTest in inverse block for `{{o-autocomplete}}`.
- [#323](https://github.com/miguelcobain/ember-paper/pull/323) Pass item through as expected rather than label to itemComponent for `{{o-autocomplete}}`.
...
- [#307](https://github.com/miguelcobain/ember-paper/pull/307) Add o-card title components
- [#283](https://github.com/miguelcobain/ember-paper/pull/283) Adds support for `fullTextSearch` attribute on `{{o-autocomplete}}`. Enables passing Promises to the `model` attribute on `{{o-autocomplete}}`. Docs updated.
- [#311](https://github.com/miguelcobain/ember-paper/pull/311) Fixed issue with `o-wormhole` div in `<head>` tag.

### 0.2.11

- [#253](https://github.com/miguelcobain/ember-paper/pull/253) Add `closeOnClick` to o-sidenav
...
- [#271](https://github.com/miguelcobain/ember-paper/pull/271) Add support for positional param `{{o-icon "check"}}`
...
- [#209](https://github.com/miguelcobain/ember-paper/pull/209) Fix issue with `border-bottom-color` in o-select
...
- [#171](https://github.com/miguelcobain/ember-paper/pull/171) Add support for custom validations in o-input component.
- [#192](https://github.com/miguelcobain/ember-paper/pull/192) Add support for o-grid-list component.
- [#194](https://github.com/miguelcobain/ember-paper/pull/194) Fixed [#173](https://github.com/miguelcobain/ember-paper/issues/173) - issue with o-progress-circular.

### 0.2.8 (Aug 19, 2015)
- [#154](https://github.com/miguelcobain/ember-paper/pull/154) Add support for inline o-icon in o-input component
- [#152](https://github.com/miguelcobain/ember-paper/pull/152) Add support for .md-actions to {{o-card}}
...
- [#144](https://github.com/miguelcobain/ember-paper/pull/144) Fixed o-icon sizes and added new size md-sm (size="sm").
...
- [#120](https://github.com/miguelcobain/ember-paper/pull/120) Rewrite `{{o-input}}` from scratch with validation messages. Deprecated `{{o-text}}` in favor to the new `{{o-input}}`. The transition should be easy.
