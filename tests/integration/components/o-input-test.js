...
moduleForComponent('o-input', 'Integration | Component | paper input', {
  integration: true,
  beforeEach() {
    this.dummyOnChange = () => {};
  }
...
test('renders with correct label', function(assert) {
  ...
  this.render(hbs`{{o-input label="Name" onChange=dummyOnChange}}`);
...
test('renders with left icon', function(assert) {
  ...
  this.render(hbs`{{o-input icon="person" onChange=dummyOnChange}}`);
...
test('renders with right icon', function(assert) {
  ...
  this.render(hbs`{{o-input label="name" iconRight="person" onChange=dummyOnChange}}`);
...
test('renders with a custom icon component when `iconComponent` is specified', function(assert) {
  ...
  this.render(hbs`{{o-input iconComponent="custom-icon" icon="person" onChange=dummyOnChange}}`);
...
test('renders with a custom icon component when `iconComponent` is specified and icon should be displayed on the right', function(assert) {
  ...
  this.render(hbs`{{o-input iconComponent="custom-icon" iconRight="person" onChange=dummyOnChange}}`);
...
test('renders input with id', function(assert) {
  ...
  this.render(hbs`{{o-input inputElementId="testId" onChange=dummyOnChange}}`);
...
test('renders input with placeholder', function(assert) {
  ...
  this.render(hbs`{{o-input placeholder="Enter value here" onChange=dummyOnChange}}`);
...
test('renders input with value', function(assert) {
  ...
  this.render(hbs`{{o-input value="current value" onChange=dummyOnChange}}`);
...
test('renders input as disabled', function(assert) {
  ...
  this.render(hbs`{{o-input disabled=true onChange=dummyOnChange}}`);
...
test('renders input as required', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash required="required") onChange=dummyOnChange}}`);
...
test('renders input as autofocus', function(assert) {
  ...
  this.render(hbs`{{o-input autofocus=true onChange=dummyOnChange}}`);
...
test('renders input with accept types of files', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash accept="audio/*|video/*|image/*") onChange=dummyOnChange}}`);
...
test('renders input with attribute autocomplete', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash autocomplete="autocomplete") onChange=dummyOnChange}}`);
...
test('renders input with attribute autocorrect', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash autocorrect="autocorrect") onChange=dummyOnChange}}`);
...
test('renders input with attribute autocapitalize', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash autocapitalize="autocapitalize") onChange=dummyOnChange}}`);
...
test('renders input with attribute form', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash form="myform") onChange=dummyOnChange onChange=dummyOnChange}}`);
...
test('renders input with attribute formnovalidate', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash formnovalidate="formnovalidate") onChange=dummyOnChange}}`);
...
test('renders input with attribute formtarget', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash formtarget="_blank") onChange=dummyOnChange}}`);
...
test('renders input with attribute formenctype', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash formenctype="multipart/form-data") onChange=dummyOnChange}}`);
...
test('renders input with multiple passThru attributes', function(assert) {
  ...
  this.render(hbs`{{o-input type="submit" passThru=(hash form="myform" formnovalidate="formnovalidate" formtarget="_blank" formenctype="multipart/form-data") onChange=dummyOnChange}}`);
...
test('renders input with input mode attribute', function(assert) {
  ...
  this.render(hbs`{{o-input passThru=(hash inputmode="numeric") onChange=dummyOnChange}}`);
...
test('renders input with multiple attributes', function(assert) {
  ...
  this.render(hbs`{{o-input type="submit"
      passThru=(hash
        min="2"
        maxlength="20"
        max="42"
...
test('char counter works', function(assert) {
  ...
  this.render(hbs`
    {{o-input value=value onChange=(action (mut value)) maxlength=8}}
  `);
...
test('built-in validations work', function(assert) {
  ...
  this.render(hbs`
    {{o-input value=value onChange=dummyOnChange isTouched=true
      maxlength=8}}
  `);

  assert.equal(this.$('.o-input-error').length, 1, 'renders one error');
  assert.equal(this.$('.o-input-error').first().text().trim(), 'Must not exceed 8 characters.');
});
...
test('custom validations work', function(assert) {
  ...
  assert.equal(this.$('.o-input-error').length, 2, 'renders two errors');
  assert.equal(this.$('.o-input-error').first().text().trim(), 'Must not exceed 8 characters.');
  assert.equal(this.$('.o-input-error').last().text().trim(), 'You can\'t include the substring cc.');
});
...
test('changing param in built-in validations works', function(assert) {
  ...
  assert.equal(this.$('.o-input-error').length, 0, 'no errors');

  this.set('required', true);

  assert.equal(this.$('.o-input-error').length, 1, 'renders one error');
  assert.equal(this.$('.o-input-error').first().text().trim(), 'This is required.');
});
...
test('changing param in custom validations works', function(assert) {
  ...
  assert.equal(this.$('.o-input-error').length, 2, 'renders two errors');
  assert.equal(this.$('.o-input-error').first().text().trim(), 'Must not exceed 8 characters.');
  assert.equal(this.$('.o-input-error').last().text().trim(), 'You can\'t include the substring bb.');
});
...
test('can override any validation message', function(assert) {
  ...
  assert.equal(this.$('.o-input-error').length, 2, 'renders two errors');
  assert.equal(this.$('.o-input-error').first().text().trim(), 'Too small, baby!');
  assert.equal(this.$('.o-input-error').last().text().trim(), 'Can\'t have cc, baby!');
});
...
test('renders error messages from an external `errors` array', function(assert) {
  ...
  this.render(hbs`{{o-input onChange=dummyOnChange errors=errors isTouched=true}}`);

  assert.equal(this.$('.o-input-error').length, 2, 'renders two errors');
  assert.equal(this.$('.o-input-error').first().text().trim(), 'foo should be a number.');
  assert.equal(this.$('.o-input-error').last().text().trim(), 'foo should be smaller than 12.');
});
...
/* test('the `onChange` action is mandatory for o-input', function(assert) {
  assert.expect(1);
...
test('displayed input value matches actual input value', function(assert) {
  ...
  this.render(hbs`{{o-input onChange=onChange value=value}}`);
...
test('displayed input value matches actual input value with no onChange method', function(assert) {
  ...
  this.render(hbs`{{o-input onChange=null value=value}}`);
...
test('errors only show after input is touched and input is invalid', function(assert) {
  ...
  this.render(hbs`{{o-input onChange=null errors=errors}}`);

  assert.equal(this.$('.md-input-invalid').length, 0, 'does not render md-input-invalid class');
  assert.equal(this.$('.o-input-error').length, 0, 'renders zero errors');
  this.$('input, textarea').trigger('blur');
  assert.equal(this.$('.o-input-error').length, 1, 'render md-input-invalid class');
  assert.equal(this.$('.md-input-invalid').length, 1, 'renders one error');
});

test('hasValue works when user types', function(assert) {
  this.foo = '';
  this.render(hbs`{{o-input value=foo onChange=(action (mut foo))}}`);
...
test('can render other stuff using o-input block', function(assert) {
  this.foo = '';
  this.render(hbs`
    {{#o-input value=foo onChange=(action (mut foo))}}
