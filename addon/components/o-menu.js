...
import layout from '../templates/components/o-menu';
  ...
  calculatePosition(trigger, content, destination, { dropdown }) {
    ...
    switch (positionMode.top) {
      ...
      case 'bottom':
        ...
        break;
      default:
        assert(`Invalid target mode '${positionMode.top}' specified for o-menu on Y axis.`);
    }
    ...
    switch (positionMode.left) {
      ...
      default: {
        assert(`Invalid target mode '${positionMode.left}' specified for o-menu on X axis.`);
      }
    }
