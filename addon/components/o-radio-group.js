...
import layout from '../templates/components/o-radio-group';
...
export default Component.extend(FocusableMixin, ParentMixin, {
  ...
  init() {
    ...
    assert('{{o-radio-group}} requires an `onChange` action or null for no action', this.get('onChange') !== undefined);
  },
