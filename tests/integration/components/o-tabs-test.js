...
moduleForComponent('o-tabs', 'Integration | Component | paper tabs', {
  integration: true
});
...
test('can change selected tab using property', function(assert) {
  ...
  this.render(hbs`
    {{#o-tabs selected=selected as |tabs|}}
      {{tabs.tab}}
      {{tabs.tab}}
      {{tabs.tab}}
    {{/o-tabs}}
...
test('onChange is triggered', async function(assert) {
  ...
  this.render(hbs`
    {{#o-tabs onChange=onChange as |tabs|}}
      {{tabs.tab}}
      {{tabs.tab}}
      {{tabs.tab}}
    {{/o-tabs}}
...
test('borderBottom true adds border', function(assert) {
  this.render(hbs`
    {{#o-tabs borderBottom=true as |tabs|}}
      {{tabs.tab}}
      {{tabs.tab}}
      {{tabs.tab}}
    {{/o-tabs}}
