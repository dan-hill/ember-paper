...
import layout from '../templates/components/o-switch';
...
export default Component.extend(FocusableMixin, RippleMixin, ColorMixin, ProxiableMixin, {
  layout,
  tagName: 'md-switch',
  classNames: ['o-switch', 'md-default-theme'],
  ...
  init() {
    this._super(...arguments);
    assert('{{o-switch}} requires an `onChange` action or null for no action.', this.get('onChange') !== undefined);
  },
