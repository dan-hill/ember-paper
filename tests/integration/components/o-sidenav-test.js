...
moduleForComponent('o-sidenav', 'Integration | Component | paper sidenav', {
  integration: true,
  beforeEach() {
...
test('renders a container with flex and layout-row classes', function(assert) {
  ...
  this.render(hbs`{{o-sidenav-container class="sidenav-container"}}`);
...
test('sidenav uses md-sidenav-right with position="right"', function(assert) {
  ...
  this.render(hbs`{{o-sidenav position="right"}}`);
...
test('sidenav starts open when `open=true`', function(assert) {
  ...
  this.render(hbs`{{o-sidenav open=true lockedOpen=false}}`);
...
test('sidenav starts closed when `open=true`', function(assert) {
  ...
  this.render(hbs`{{o-sidenav open=false lockedOpen=false}}`);
...
test('should trigger an action when clicking on backdrop', function(assert) {
  ...
  this.render(hbs`
    {{#o-sidenav open=true onToggle=(action sidenavToggle) lockedOpen=false}}
      Hi!
    {{/o-sidenav}}
  `);
...
test('sidenav opens when `open` is changed to `true`', function(assert) {
  ...
  this.render(hbs`{{o-sidenav open=isOpen lockedOpen=false}}`);
...
test('should trigger an action when clicking inside sidenav with `closeOnClick=true` (default)', function(assert) {
  ...
  this.render(hbs`
    {{#o-sidenav open=true onToggle=(action sidenavToggle) closeOnClick=false lockedOpen=false}}
      Hi!
    {{/o-sidenav}}
  `);
...
test('should trigger an action when clicking sidenav-toggle ("default" name)', function(assert) {
  ...
  this.render(hbs`
    {{#o-sidenav open=true onToggle=(action sidenavToggle) lockedOpen=false}}
      Hi!
    {{/o-sidenav}}
    {{#o-sidenav-toggle as |toggleAction|}}
      {{#o-button id="toggle-button" onClick=(action toggleAction)}}
        Toggle sidenav
      {{/o-button}}
    {{/o-sidenav-toggle}}
  `);
...
test('should trigger an action when clicking sidenav-toggle (custom name)', function(assert) {
  ...
  this.render(hbs`
    {{#o-sidenav name="balele" open=true onToggle=(action sidenavToggle) lockedOpen=false}}
      Hi!
    {{/o-sidenav}}
    {{#o-sidenav name="balili" open=true onToggle=(action sidenavToggle) lockedOpen=false}}
      Hi!
    {{/o-sidenav}}
    {{#o-sidenav-toggle name="balele" as |toggleAction|}}
      {{#o-button id="toggle-button" onClick=(action toggleAction)}}
        Toggle sidenav
      {{/o-button}}
    {{/o-sidenav-toggle}}
...
/* test('clicking sidenav-toggle for unregistered sidenav should throw', function(assert) {
  ...
  this.render(hbs`
    {{#o-sidenav name="balele" open=true onToggle=(action sidenavToggle) lockedOpen=false}}
      Hi!
    {{/o-sidenav}}
    {{#o-sidenav-toggle name="çup" as |toggleAction|}}
      {{#o-button id="toggle-button" onClick=(action toggleAction)}}
        Toggle sidenav
      {{/o-button}}
    {{/o-sidenav-toggle}}
