...
import layout from '../templates/components/o-chips';
...
export default Component.extend({
  ...
  actions: {
    ...
    inputFocus(autocomplete) {
      ...
      if (isEmpty(this.get('autocomplete')) && input.is('.ember-o-autocomplete-search-input')) {
  ...
  resetInput() {
    ...
    if (input.is('.ember-o-autocomplete-search-input') && isPresent(select)) {
