...
import layout from '../templates/components/o-autocomplete';
...
export default PowerSelect.extend(ValidationMixin, ChildMixin, {
  ...
  util: service(),
  constants: service(),
  triggerComponent: 'o-autocomplete-trigger',
  contentComponent: 'o-autocomplete-content',
  optionsComponent: 'o-autocomplete-options',
  triggerWrapperComponent: 'o-autocomplete-trigger-container',
  ...
  _initComponent() {
    ...
    assert('{{o-autocomplete}} requires at least one of the `onSelectionChange` or `onSearchTextChange` functions to be provided.', hasTextChange || hasSelectionChange);
