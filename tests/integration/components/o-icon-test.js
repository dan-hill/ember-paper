...
moduleForComponent('o-icon', 'Integration | Component | paper icon', {
  integration: true
});
...
test('it renders with tag name', function(assert) {
  ...
  this.render(hbs`{{o-icon icon="check"}}`);
...
test('it renders with classes', function(assert) {
  ...
  this.set('icon', 'foo');
  this.render(hbs`{{o-icon icon}}`);

  let $component = this.$('md-icon');

  assert.ok($component.hasClass('o-icon'));
...
test('it renders with spin class', function(assert) {
  ...
  this.set('spin', true);
  this.render(hbs`{{o-icon "check" spin=spin}}`);
...
test('it renders with reverse spin class', function(assert) {
  ...
  this.render(hbs`{{o-icon "check" reverseSpin=reverseSpin}}`);
...
test('it renders with size styles', function(assert) {
  ...
  this.set('size', 12);
  this.render(hbs`{{o-icon "check" size=size}}`);
...
test('it renders with a provided aria-label', function(assert) {
  ...
  this.render(hbs`{{o-icon "check" aria-label=ariaLabel}}`);
...
test('it renders the correct ligature when given a dashed or underscored icon name', function(assert) {
  ...
  this.render(hbs`{{o-icon iconName}}`);
