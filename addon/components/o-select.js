...
import layout from '../templates/components/o-select';
...
export default PowerSelect.extend(ValidationMixin, ChildMixin, FocusableMixin, {
  ...
  optionsComponent: 'o-select-options',
  triggerComponent: 'o-select-trigger',
  beforeOptionsComponent: 'o-select-search',
